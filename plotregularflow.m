...
%optimal fc for T1=lp 0.6, hp 50
%[avt,avf,avp]=shuntplot(T1,0,fc,1,pkh,pkd,D,0);

%[avt,avf,avp]=shuntplot(T2,1,fc,1,pkh,pkd,D,0);

%[avt,avf,avp]=shuntplot(T3,2,fc,1,pkh,pkd,D,0); %NO

%[avt,avf,avp]=shuntplot(T4,3,fc,1,pkh,pkd,D,0); %NO

%[avt,avf,avp]=shuntplot(T5,4,fc,1,pkh,pkd,D,0);
